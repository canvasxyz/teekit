...
echo "  az disk delete --name <DISK_NAME> --resource-group $RESOURCE_GROUP --yes"
echo "  az network nic delete --name <NIC_NAME> --resource-group $RESOURCE_GROUP"
echo "  az network public-ip delete --name <IP_NAME> --resource-group $RESOURCE_GROUP"
echo "  az network nsg delete --name <NSG_NAME> --resource-group $RESOURCE_GROUP"
echo "  az storage account delete --name <STORAGE_ACCOUNT> --resource-group $RESOURCE_GROUP --yes"
echo "  az sig delete --gallery-name <GALLERY_NAME> --resource-group $RESOURCE_GROUP"
echo "  az group delete --name $RESOURCE_GROUP --yes   # Deletes all resources in the group"
echo ""

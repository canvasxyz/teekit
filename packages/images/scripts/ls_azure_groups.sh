...
echo ""
echo "VM Operations:"
echo "  az serial-console connect --name <VM_NAME> --resource-group <GROUP_NAME>"
echo "  az vm boot-diagnostics get-boot-log --name <VM_NAME> --resource-group <GROUP_NAME>"
echo "  az vm start --name <VM_NAME> --resource-group <GROUP_NAME>"
echo "  az vm restart --name <VM_NAME> --resource-group <GROUP_NAME>"
echo "  az vm stop --name <VM_NAME> --resource-group <GROUP_NAME>"
echo "  az vm delete --name <VM_NAME> --resource-group <GROUP_NAME> --yes"
echo "  ssh root@<PUBLIC_IP>"
echo ""
echo "Delete Resources:"
echo "  az disk delete --name <DISK_NAME> --resource-group <GROUP_NAME> --yes"
echo "  az network nic delete --name <NIC_NAME> --resource-group <GROUP_NAME>"
echo "  az network public-ip delete --name <IP_NAME> --resource-group <GROUP_NAME>"
echo "  az network nsg delete --name <NSG_NAME> --resource-group <GROUP_NAME>"
echo "  az storage account delete --name <STORAGE_ACCOUNT> --resource-group <GROUP_NAME> --yes"
echo "  az sig delete --gallery-name <GALLERY_NAME> --resource-group <GROUP_NAME>"
echo "  az group delete --name <GROUP_NAME> --yes   # Deletes all resources in the group"
echo ""
